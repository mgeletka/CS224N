...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.h_projection = nn.Linear(in_features=hidden_size * 2, out_features=hidden_size, bias=False) #bideractional to unidirectional
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for y_t in torch.split(y, 1, dim=0):
            ...
            dec_state, combined_output, _ = self.step(Ybar_t=ybar_t, dec_state=dec_init_state, enc_hiddens=enc_hiddens, enc_hiddens_proj=enc_hiddens_proj,enc_masks=enc_masks)
